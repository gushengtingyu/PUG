;(() => {
	...
	function it(t, e) {
		typeof e == "function" ? (t._x_cleanups || (t._x_cleanups = []), t._x_cleanups.push(e)) : ((e = t), nr.push(e))
	}
	function Tt(t) {
		rr.push(t)
	}
	...
	function fe(t, e) {
		t._x_attributeCleanups &&
			Object.entries(t._x_attributeCleanups).forEach(([r, n]) => {
				;(e === void 0 || e.includes(r)) && (n.forEach((i) => i()), delete t._x_attributeCleanups[r])
			})
	}
	function sr(t) {
		for (t._x_effects?.forEach(Ye); t._x_cleanups?.length; ) t._x_cleanups.pop()()
	}
	var de = new MutationObserver(_e),
		pe = !1
	function mt() {
		;(de.observe(document, { subtree: !0, childList: !0, attributes: !0, attributeOldValue: !0 }), (pe = !0))
	}
	function me() {
	...
	var Kn = {
		...
		get({ objects: t }, e, r) {
			return e == "toJSON" ? Vn : Reflect.get(t.find((n) => Reflect.has(n, e)) || {}, e, r)
		},
		set({ objects: t }, e, r, n) {
			let i = t.find((s) => Object.prototype.hasOwnProperty.call(s, e)) || t[t.length - 1],
...
`
	...
	function ht(t, e, r, n, i) {
		if (at && typeof e == "function") {
			let o = e.apply(r, n)
			o instanceof Promise ? o.then((s) => ht(t, s, r, n)).catch((s) => st(s, i, e)) : t(o)
	...
	function xr(t, e, r = {}) {
		...
		if (e.includes("await")) {
			...
			return new a(["scope"], `with (scope) { let __result = ${c}; return __result }`).call(r.context, o)
		} else {
			let a = /^[\n\s]*if.*\(.*\)/.test(e.trim()) || /^(let|const)\s/.test(e.trim()) ? `(()=>{ ${e} })()` : e,
				l = new Function(["scope"], `with (scope) { let __result = ${a}; return __result }`).call(r.context, o)
	...
	function xe(t) {
		...
		return (
			e.push(i),
			[
				{ Alpine: K, effect: n, cleanup: r, evaluateLater: x.bind(x, t), evaluate: N.bind(N, t) },
				() => e.forEach((a) => a())
			]
		)
	}
	function Xn(t, e) {
		...
		let s = () => {
			t._x_ignore ||
				t._x_ignoreSelf ||
				(n.inline && n.inline(t, e, i), (n = n.bind(n, t, e, i)), we ? _t.get(wr).push(n) : n())
		}
	...
	function vr(t = () => {}) {
		return ({ name: e, value: r }) => {
			let { name: n, value: i } = Sr.reduce((o, s) => s(o), { name: e, value: r })
	...
	function Z(t, e, r = {}) {
		t.dispatchEvent(new CustomEvent(e, { detail: r, bubbles: !0, composed: !0, cancelable: !0 }))
	}
	function $(t, e) {
	...
	function ei() {
		;[
			...
			br(r) ||
				n.some((i) => {
					if (document.querySelector(i)) return (w(`found "${i}", but missing ${e} plugin`), !0)
				})
		})
	}
	var Oe = [],
	...
	function ri(t, e) {
		...
		return (
			...
			() => {
				;(s.forEach((a) => t.classList.add(a)), o.forEach((a) => t.classList.remove(a)))
			}
		)
	}
	function tt(t, e) {
	...
	function ni(t, e) {
		...
		return (
			Object.entries(e).forEach(([n, i]) => {
				;((r[n] = t.style[n]), n.startsWith("--") || (n = oi(n)), t.style.setProperty(n, i))
			}),
			setTimeout(() => {
	...
	d("transition", (t, { value: e, modifiers: r, expression: n }, { evaluate: i }) => {
		;(typeof n == "function" && (n = i(n)), n !== !1 && (!n || typeof n == "boolean" ? ai(t, r, e) : si(t, n, e)))
	})
	function si(t, e, r) {
		;(Lr(t, xt, ""),
			{
	...
	function ai(t, e, r) {
		...
		;(e.includes("in") && !n && (e = e.filter((m, b) => b < e.indexOf("out"))),
			e.includes("out") && !n && (e = e.filter((m, b) => b > e.indexOf("out"))))
	...
	function Lr(t, e, r = {}) {
		t._x_transition ||
			(t._x_transition = {
				...
				in(n = () => {}, i = () => {}) {
					Ft(t, e, { during: this.enter.during, start: this.enter.start, end: this.enter.end }, n, i)
				},
				out(n = () => {}, i = () => {}) {
					Ft(t, e, { during: this.leave.during, start: this.leave.start, end: this.leave.end }, n, i)
				}
			})
	}
	...
	function Ft(t, e, { during: r, start: n, end: i } = {}, o = () => {}, s = () => {}) {
		if (
	...
	function ci(t, e) {
		...
		;((t._x_transitioning = {
			...
			requestAnimationFrame(() => {
				if (r) return
				let s = Number(getComputedStyle(t).transitionDuration.replace(/,.*/, "").replace("s", "")) * 1e3,
	...
	function wt(t, e, r, n = []) {
		switch (
			(t._x_bindings || (t._x_bindings = M({})), (t._x_bindings[e] = r), (e = n.includes("camel") ? gi(e) : e), e)
		) {
			case "value":
				ui(t, r)
				break
	...
	function ui(t, e) {
		if (Te(t))
			(t.attributes.value === void 0 && (t.value = e),
				window.fromModel &&
					(typeof e == "boolean" ? (t.checked = Et(t.value) === e) : (t.checked = Vr(t.value, e))))
		else if (zt(t))
			Number.isInteger(e)
				? (t.value = e)
	...
	function fi(t, e) {
		;(t._x_undoAddedClasses && t._x_undoAddedClasses(), (t._x_undoAddedClasses = xt(t, e)))
	}
	function di(t, e) {
		;(t._x_undoAddedStyles && t._x_undoAddedStyles(), (t._x_undoAddedStyles = tt(t, e)))
	}
	function pi(t, e, r) {
		;(Ur(t, e, r), hi(t, e, r))
	}
	function Ur(t, e, r) {
		;[null, void 0, !1].includes(r) && yi(e) ? t.removeAttribute(e) : (qr(e) && (r = e), mi(t, e, r))
	}
	function mi(t, e, r) {
	...
	function Wr(t, e, r) {
		return t._x_bindings && t._x_bindings[e] !== void 0 ? t._x_bindings[e] : Jr(t, e, r)
	}
	...
	function Jr(t, e, r) {
		...
		return n === null ? (typeof r == "function" ? r() : r) : n === "" ? !0 : qr(e) ? !![e, "true"].includes(n) : n
	}
	function zt(t) {
	...
	var wi = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly"
	var Gs = Ne(
		wi +
	...
	var Si = Object.prototype.toString,
		cn = (t) => Si.call(t),
		ke = (t) => cn(t).slice(8, -1)
	var qt = (t) => vi(t) && t !== "NaN" && t[0] !== "-" && "" + parseInt(t, 10) === t
	var Wt = (t) => {
	...
	function hn(t) {
		t.active && (_n(t), t.options.onStop && t.options.onStop(), (t.active = !1))
	}
	var Ti = 0
	function Ri(t, e) {
		let r = function () {
	...
	function k(t, e, r) {
		...
		;(i || n.set(r, (i = new Set())),
			i.has(B) ||
				(i.add(B),
				B.deps.push(i),
				B.options.onTrack && B.options.onTrack({ effect: B, target: t, type: e, key: r })))
	}
	function J(t, e, r, n, i, o) {
		...
		if (e === "clear") s.forEach(c)
			...
			switch ((r !== void 0 && c(s.get(r)), e)) {
				case "add":
					W(t) ? qt(r) && c(s.get("length")) : (c(s.get(rt)), ut(t) && c(s.get($e)))
					break
				case "delete":
		...
		let l = (u) => {
			;(u.options.onTrigger &&
				u.options.onTrigger({ effect: u, target: t, key: r, type: e, newValue: n, oldValue: i, oldTarget: o }),
	...
	function yn(t = !1, e = !1) {
		return function (n, i, o) {
			...
			if (i === "__v_raw" && o === (t ? (e ? Xi : vn) : e ? Yi : En).get(n)) return n
			let s = W(n)
	...
	function Li(t = !1) {
		return function (r, n, i, o) {
			let s = r[n]
			if (!t && ((i = g(i)), (s = g(s)), !W(r) && Le(s) && !Le(i))) return ((s.value = i), !0)
			let a = W(r) && qt(n) ? Number(n) < r.length : vt(r, n),
				c = Reflect.set(r, n, i, o)
			return (r === g(o) && (a ? Pe(i, s) && J(r, "set", n, i, s) : J(r, "add", n, i)), c)
		}
	}
	function ji(t, e) {
		let r = vt(t, e),
	...
	function Jt(t, e = !1) {
		let r = this.__v_raw,
			n = g(r),
			i = g(t)
		return (t !== i && !e && k(n, "has", t), !e && k(n, "has", i), t === i ? r.has(t) : r.has(t) || r.has(i))
	}
	function Yt(t, e = !1) {
		return ((t = t.__v_raw), !e && k(g(t), "iterate", rt), Reflect.get(t, "size", t))
	}
	function un(t) {
		t = g(t)
		let e = g(this)
	...
	function fn(t, e) {
		...
		let s = i.call(r, t)
		return (r.set(t, e), o ? Pe(e, s) && J(r, "set", t, e, s) : J(r, "add", t, e), this)
	}
	function dn(t) {
		let e = g(this),
			{ has: r, get: n } = Qt(e),
	...
	function Xt(t, e) {
		return function (n, i) {
			let o = this,
				...
				a = g(s),
				c = e ? ze : t ? Be : Fe
			return (!t && k(a, "iterate", rt), s.forEach((l, u) => n.call(i, c(l), c(u), o)))
		}
	}
	function Zt(t, e, r) {
		return function (...n) {
			...
			return (
				!e && k(o, "iterate", c ? $e : rt),
				{
					next() {
						...
						return v ? { value: p, done: v } : { value: a ? [u(p[0]), u(p[1])] : u(p), done: v }
					},
					[Symbol.iterator]() {
						return this
					}
		...
		return function (...e) {
			{
				...
				console.warn(`${De(t)} operation ${r}failed: target is readonly.`, g(this))
			}
	...
	function Ki() {
		...
		return (
			["keys", "values", "entries", Symbol.iterator].forEach((o) => {
				;((t[o] = Zt(o, !1, !1)), (r[o] = Zt(o, !0, !1)), (e[o] = Zt(o, !1, !0)), (n[o] = Zt(o, !0, !0)))
			}),
			[t, r, e, n]
		)
	}
	...
	function An(t, e, r, n, i) {
		if (!St(t)) return (console.warn(`value cannot be made reactive: ${String(t)}`), t)
	...
	y("data", (t) => Mt(t))
	y("root", (t) => Q(t))
	y("refs", (t) => (t._x_refs_proxy || (t._x_refs_proxy = I(to(t))), t._x_refs_proxy))
	function to(t) {
		let e = []
		return (
			L(t, (r) => {
	...
	d("modelable", (t, { expression: e }, { effect: r, evaluateLater: n, cleanup: i }) => {
		let o = n(e),
			s = () => {
				let u
				return (o((p) => (u = p)), u)
	...
	d("teleport", (t, { modifiers: e, expression: r }, { cleanup: n }) => {
		t.tagName.toLowerCase() !== "template" && w("x-teleport can only be used on a <template> tag", t)
		let i = Rn(r),
	...
	function V(t, e, r, n) {
		...
		return (
			...
			e === "submit" &&
				(o = a(o, (c, l) => {
					;(l.target._x_pendingModelUpdates && l.target._x_pendingModelUpdates.forEach((u) => u()), c(l))
				})),
			(so(e) || kn(e)) &&
				(o = a(o, (c, l) => {
					ao(l, r) || c(l)
	...
	function ao(t, e) {
		...
		if (r.length === 0 || (r.length === 1 && Nn(t.key).includes(r[0]))) return !1
		let i = ["ctrl", "shift", "alt", "meta", "cmd", "super"].filter((o) => r.includes(o))
		return (
			(r = r.filter((o) => !i.includes(o))),
			!(
				i.length > 0 &&
				i.filter((s) => ((s === "cmd" || s === "super") && (s = "meta"), t[`${s}Key`])).length === i.length &&
	...
	d("model", (t, { modifiers: e, expression: r }, { effect: n, cleanup: i }) => {
		let o = t
		...
		let c = () => {
			...
			l = (_) => {
				let f
				;(s((m) => (f = m)), Dn(f) ? f.set(_) : a(() => {}, { scope: { __placeholder: _ } }))
			}
		typeof r == "string" &&
			t.type === "radio" &&
			h(() => {
		...
		if (F) R = () => {}
			...
			let _ = [],
				f = (m) => l(re(t, e, m, c()))
			if ((u && _.push(V(t, "change", e, f)), p && (_.push(V(t, "blur", e, f)), t.form))) {
				let m = () => f({ target: t })
				;(t.form._x_pendingModelUpdates || (t.form._x_pendingModelUpdates = []),
					t.form._x_pendingModelUpdates.push(m),
					i(() => t.form._x_pendingModelUpdates.splice(t.form._x_pendingModelUpdates.indexOf(m), 1)))
			}
			;(v &&
				_.push(
					V(t, "keydown", e, (m) => {
			...
			let _ = t.tagName.toLowerCase() === "select" || ["checkbox", "radio"].includes(t.type) ? "change" : "input"
			R = V(t, _, e, (f) => {
				l(re(t, e, f, c()))
			})
		}
		...
		;((t._x_model = {
			...
			n(() => {
				let _ = c()
				;(e.includes("unintrusive") && document.activeElement.isSameNode(t)) || t._x_forceModelUpdate(_)
			}))
	})
	function re(t, e, r, n) {
		return h(() => {
			...
			if (zt(t))
					...
					return (
						e.includes("number")
							...
							: e.includes("boolean")
								? (i = Et(r.target.value))
								: (i = r.target.value),
						r.target.checked ? (n.includes(i) ? n : n.concat([i])) : n.filter((o) => !co(o, i))
					)
							...
							: Array.from(r.target.selectedOptions).map((i) => i.value || i.text)
				{
					let i
					return (
						Te(t) ? (r.target.checked ? (i = r.target.value) : (i = n)) : (i = r.target.value),
						e.includes("number") ? Ve(i) : e.includes("boolean") ? Et(i) : e.includes("trim") ? i.trim() : i
					)
				}
			}
		})
	...
	d("cloak", (t) => queueMicrotask(() => h(() => t.removeAttribute(T("cloak")))))
	Lt(() => `[${T("init")}]`)
	d(
		"init",
		A((t, { expression: e }, { evaluate: r }) => (typeof e == "string" ? !!e.trim() && r(e, {}, !1) : r(e, {}, !1)))
	)
	...
	ct(Pt(":", It(T("bind:"))))
	var Pn = (t, { value: e, modifiers: r, expression: n, original: i }, { effect: o, cleanup: s }) => {
		if (!e) {
			let c = {}
			;(rn(c),
				x(t, n)(
		...
		;(o(() =>
			a((c) => {
				;(c === void 0 && typeof n == "string" && n.match(/\./) && (c = ""), h(() => wt(t, e, c, r)))
			})
		),
			s(() => {
	...
	d("show", (t, { modifiers: e, expression: r }, { effect: n }) => {
		...
		n(() =>
			i((p) => {
				;(!u && p === l) || (e.includes("immediate") && (p ? a() : o()), c(p), (l = p), (u = !1))
			})
		)
	})
	...
	function po(t, e, r, n) {
		let i = (s) => typeof s == "object" && !Array.isArray(s),
			o = t
		r((s) => {
			;(ho(s) && s >= 0 && (s = Array.from(Array(s).keys(), (f) => f + 1)), s === void 0 && (s = []))
			let a = t._x_lookup,
				c = t._x_prevKeys,
				l = [],
				u = []
			...
			for (let f = 0; f < p.length; f++) {
				...
				;(P(dt, qe, o),
					...
					typeof nt == "object" && w("x-for key cannot be an object, it must be a string or an integer", o),
					(a[nt] = dt))
			}
			for (let f = 0; f < R.length; f++) a[R[f]]._x_refreshXForScope(l[u.indexOf(R[f])])
			o._x_prevKeys = u
		})
	}
	function mo(t) {
		...
		return (
			a
				? ((o.item = s.replace(e, "").trim()), (o.index = a[1].trim()), a[2] && (o.collection = a[2].trim()))
				: (o.item = s),
			o
		)
	}
	...
	$n.inline = (t, { expression: e }, { cleanup: r }) => {
		let n = Q(t)
		;(n._x_refs || (n._x_refs = {}), (n._x_refs[e] = t), r(() => delete n._x_refs[e]))
	}
	d("ref", $n)
	d("if", (t, { expression: e }, { effect: r, cleanup: n }) => {
		t.tagName.toLowerCase() !== "template" && w("x-if can only be used on a <template> tag", t)
		let i = x(t, e),
			o = () => {
